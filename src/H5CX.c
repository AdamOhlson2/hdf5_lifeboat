...
/*-------------------------------------------------------------------------
 * Function:    H5CX_set_vlen_chunk_ctx
 *
...
H5CX_set_vlen_chunk_ctx(void *ctx)
{
    ...
    (*head)->ctx.vlen_chunk_ctx = ctx;

    FUNC_LEAVE_NOAPI_VOID

} /* end H5CX_set_vlen_chunk() */

/*-------------------------------------------------------------------------
 * Function:    H5CX_get_vlen_chunk_ctx
 *
 * Purpose:     Retrieves the chunk-local VL context for the current
